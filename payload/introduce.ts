...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    '다양한 기술 스택을 경험한 6년 차 웹 개발자입니다. 시니어 개발자로 성장하기 위해 프로젝트의 전반적인 구조를 이해하고 문제를 능동적으로 찾아내어 해결방안을 제시할 수 있도록 노력합니다. 팀원들의 코드 리뷰에 적극적으로 참여하며 인사이트를 제시하고 협업하였습니다. 팀장의 부재 시에는 팀장 대행으로서 팀의 리딩 역할을 대신 수행해 왔습니다.',
